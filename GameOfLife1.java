/**
	...
	public  class GameOfLife1
	{
	    ...
	    public final static void main(String[] args)
	    {
	        ...
	        GameOfLife1 gof = new GameOfLife1();
	        gof.test(5);
	    }
	    ...
	    private void test(int nrIterations) {
	        ...
	        System.out.println("Original Grid Generation:");
	        printBoard(board);
	        
	        for (int i = 0 ; i < nrIterations ; i++) {
	            System.out.println();
	            board = getNextBoard(board);
	            System.out.println("Next Coming Generation:");
	            printBoard(board);
	        }
	    }
	    ...
	    public int[][] getNextBoard(int[][] board) {
	        ...
	        System.out.println("Live Cells And Dead Cells:");
